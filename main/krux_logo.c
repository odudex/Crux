...
void draw_krux_logo(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_bg_color(rect1, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_bg_color(rect2, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_bg_color(rect3, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_bg_color(rect4, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_bg_color(rect5, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_bg_color(rect6, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_bg_color(rect7, lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_bg_color(rect8, lv_color_hex(0xFFFFFF), 0);
