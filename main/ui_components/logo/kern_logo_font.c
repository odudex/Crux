 ...
 * Size: 100 px
 * Bpp: 4
 * Opts: --bpp 4 --size 100 --no-compress --stride 1 --align 1 --font Montserrat-Medium.ttf --symbols KERN --format lvgl -o kern_logo_100.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1072, .box_w = 52, .box_h = 71, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 1846, .adv_w = 1150, .box_w = 62, .box_h = 71, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 4047, .adv_w = 1299, .box_w = 61, .box_h = 71, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 6213, .adv_w = 1163, .box_w = 59, .box_h = 71, .ofs_x = 10, .ofs_y = 0}
};
...
{
    {
        .range_start = 69, .range_length = 14, .glyph_id_start = 1,
